...
/* 
    Backtracking is an algorithm-technique for solving recursive
    problem by trying to build every possible solution incrementally and
    removing those solutions that fail to satisfy the constraints of the
    problem at any points of time.
*/
